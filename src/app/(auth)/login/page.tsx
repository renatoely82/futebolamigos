          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full bg-white border border-[#e2e8f0] rounded-lg px-4 py-3 pr-12 text-gray-800 placeholder-gray-400 focus:outline-none focus:border-green-500 transition-colors"
                placeholder="••••••••"
              />
              <button
                type="button"
