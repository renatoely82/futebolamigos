  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1">Posição Principal *</label>
          <select
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1">2ª Posição</label>
          <select
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1">3ª Posição</label>
          <select
